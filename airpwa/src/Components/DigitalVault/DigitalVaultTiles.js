    ...
    <React.Fragment>
      ...
      <main>
        ...
        <Button variant="contained" color="primary" onClick={handleShow}>
          <b>Open/Close Camera for Digital Face ID</b>
        </Button>
        ...
        >
          <DialogTitle id="alert-dialog-title">{"Digital Face ID"}</DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Welcome on-board Darshan! Face ID Contactless check-INs &
              validations on safety rules will assist you at various checkpoints
            </DialogContentText>
          </DialogContent>
          <DialogActions>
...
const featuredPosts = [
  {
    ...
    image:
      "https://resize.indiatvnews.com/en/resize/newbucket/1200_-/2021/03/passport-1617188053.jpg",
  ...
  },
  {
    ...
    description: "Status: Verified & Validated",
    image:
      "https://3.imimg.com/data3/GP/DL/MY-9910671/visa-and-passpor-service-500x500.png",
    imageText: "Artists name",
    readmore:
  ...
  },
  {
    ...
    description: "Status: Verified & Validated",
    image:
      "https://static.toiimg.com/thumb/msid-84309266,width-1200,height-900,resizemode-4/.jpg",
    imageText: "Artists name",
    readmore:
...

  {
    ...
    description: "Status: Verified & Validated",
    image:
      "https://images.livemint.com/img/2021/08/24/1600x900/2cd6397c-04be-11ec-89fd-c0c117172485_1629832872875_1629832929484.jpg",
    imageText: "Artists name",
    readmore:
...

  {
    ...
    description: "Status: Verified & Validated",
    image:
      "https://media.cntraveler.com/photos/5b47bf2c4b1b564ac0e61d76/4:5/w_832,h_1040,c_limit/CNT_Intel_Plane%20Tickets_072018_TM%20Detwiler.jpg",
    imageText: "Artists name",
    readmore:
